        ...
        <div class="container mx-auto mt-4 p-4 bg-white shadow-md rounded-lg">
            <div class="p-4">
                <div class="grid grid-cols-3 gap-4 mb-4">
                    ...
                    <span class="col-span-2">Project Allocation and Management System</span>
                </div>
                <div class="grid grid-cols-3 gap-4 mb-4">
                    <span class="text-gray-700 font-bold mb-2 col-span-1">Course:</span>
                    <span class="col-span-2">Project I</span>
                </div>
                <div class="grid grid-cols-3 gap-4 mb-4">
                ...
                <div class="grid grid-cols-3 gap-4 mb-4">
                    ...
                    <span class="col-span-2">web</span>
                </div>
                <div class="grid grid-cols-3 gap-4 mb-4">
                    <span class="text-gray-700 font-bold mb-2 col-span-1">Description:</span>
                    <span class="col-span-2">fhskjdf skfg dugya dudgjadgjs uhfjeh fusdyfgjesnfsjd easfjdsgysdjdudf
                        fsdfuydsfudshfdjskf usjfhdjs  dudj fdyfwiwry fccufsfisryas 
                    </span>
                </div>
                
                <div class="grid grid-cols-3 gap-4 mb-4">
                    <span class="text-gray-700 font-bold mb-2 col-span-1">Group:</span>
                    <span class="col-span-2">lajimolaa</span>
                </div>
                <div class="grid grid-cols-3 gap-4 mb-4">
