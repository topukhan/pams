    ...
    <div class="container px-6 mx-auto grid">
        ...
        <div class="px-4 ">
            <ol class="flex justify-end text-gray-500">
                ...
                <li class="mr-3">/ </li>
                <li>
                    <a href="{{ route('domains.index') }}" class="text-gray-900 dark:text-white">
                        Domain</a>
                </li>
            </ol>
        </div>
                    ...
                    <div class="flex items-center justify-start mt-4">
                        <nav class="flex items-center">
                            ...
                            <span class="px-2 py-1 text-sm font-medium leading-5 text-gray-600">
                                Page: {{ $domains->currentPage() }} of {{ $domains->lastPage() }} Records:
                                {{ $domains->total() }}
                            </span>
                            ...
                            @if ($domains->hasMorePages())
                                ...
                                <a href="{{ $domains->url($domains->lastPage()) }}"
