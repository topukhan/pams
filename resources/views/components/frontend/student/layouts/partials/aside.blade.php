...
<aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
    <div class="py-4  text-gray-500 dark:text-gray-400">
        <a class="ml-6 mr-2 text-lg font-bold text-gray-800 dark:text-gray-200" href="{{ route('student.dashboard') }}">
            PAMS
            <a href="{{ route('student.getStarted') }}">
                <button
                    class="px-2 py-1 text-sm font-semibold leading-tight text-purple-700 bg-purple-100 rounded-full dark:bg-purple-700 dark:text-purple-100">
                    Get Started
                </button></a>
        </a>
        {{-- Dashboard --}}
        ...
        <ul>
            ...
            <li class="relative px-6 py-3">
                <button
                    ...
                    @click="toggleGroupsMenu" aria-haspopup="true">
                ...
                <template x-if="isGroupsMenuOpen">
            ...
            <li class="relative px-6 py-3">
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    href=" {{ route('student.supervisor.availability') }} ">
                    <i class='bx bx-id-card text-2xl'></i>
                    <span class="ml-4">Supervisor</span>
                </a>
            </li>

            @if (session('projectExists') == false)
                {{-- Project Proposal --}}
                <li class="relative px-6 py-3">
                    <button
                        class="inline-flex items-center justify-between w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                        @click="toggleProposalMenu" aria-haspopup="true">
                        <span class="inline-flex items-center">
                            <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                                stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                                <path
                            ...
                            <span class="ml-4">Project Proposal</span>
                        </span>
                        <svg class="w-4 h-4" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                                d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                        ...
                        <ul x-transition:enter="transition-all ease-in-out duration-300"
                            ...
                            <li
                                ...
                                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                                    ...
                                    <span class="ml-4">Proposal Form</span></a>
                            </li>
                            <li
                                class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                                    href="{{ route('student.proposalStatus') }}">
                                    {{-- <i class='bx bx-list-ul text-2xl'></i> --}}
                                    <span class="ml-4">Feedback</span></a>
                            </li>
                    ...
                    <template x-if="isProposalOpen">
                        <ul x-transition:enter="transition-all ease-in-out duration-300"
                            ...
                            <li
                                class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                                    href="{{ route('student.myProject') }}">
                                    {{-- <i class='bx bx-task text-2xl'></i>                                 --}}
                                    <span class="ml-4">Project Details</span></a>
                            </li>
                            <li
                                class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                                    href="{{ route('student.reportSubmission') }}">
                                    {{-- <i class='bx bx-list-ul text-2xl'></i> --}}
                                    <span class="ml-4">Submit Report</span></a>
                            </li>
                            <li
                                class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                                    href="{{ route('student.reportSubmission') }}">
                                    {{-- <i class='bx bx-list-ul text-2xl'></i> --}}
                                    <span class="ml-4">Report Feedback</span></a>
                            </li>
            ...
            <li class="relative px-6 py-3">
                <button
                    class="inline-flex items-center justify-between w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    @click="toggleFollowUpsMenu" aria-haspopup="true">
                    <span class="inline-flex items-center">
...
<aside class="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-white dark:bg-gray-800 md:hidden"
    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
        <a class="ml-6 text-lg font-bold text-gray-800 dark:text-gray-200" href="{{ route('student.dashboard') }}">
            PAMS
        </a>
        {{-- Dashboard --}}
        <ul class="mt-6">
            ...
            <li class="relative px-6 py-3">
                ...
                <template x-if="isFollowUpsOpen">
                    <ul x-transition:enter="transition-all ease-in-out duration-300"
                        ...
                        <li
                            class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                            <a class="w-full" href="{{ route('student.taskList') }}">Tasks</a>
                        </li>
                        <li
                            class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                            <a class="w-full" href="{{ route('student.upcomingEvents') }}">Upcoming Events</a>
                        </li>
