        ...
        <div class="px-2 py-2 ">
            <div class="max-w-3xl mx-auto mt-8 p-8 bg-white rounded-lg shadow-lg">
                <div class="mb-6">
                    ...
                    <p class="text-gray-600 text-sm mt-2">Posted on August 5, 2023</p>
                    ...
                    <p class="text-gray-600 flex justify-end text-sm mt-2">On: August 39, 2023</p>
                    <p class="text-gray-600 flex justify-end text-sm mt-2">At: 1pm</p>
                </div>
            </div>
        </div>
