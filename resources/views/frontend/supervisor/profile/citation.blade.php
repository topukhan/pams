            ...
            <div class="max-w-3xl mx-auto p-8 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                <form action="{{ route('supervisor.citationStore') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="flex mb-1">
                            <label for="citation"
                                class="form-input rounded-md bg-gray-200 border-none text-black text-sm font-bold mr-2 dark:text-gray-300">
                                1.
                            </label>
                            <input name="citation[]" type="text" placeholder="Enter Your Citation Here"
                                class="block w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring focus:border-blue-600 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200">

                            <button type="button" class="ml-2 p-2 text-white text-2xl font-bold rounded-md "
                                onclick="removeCitationRow(this)"> &minus;
                            </button>
                        </div>
                        @error('citation.*')
                            <p class="text-red-600 text-sm mt-2 block">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                addCitationButton.addEventListener('click', () => {
                    ...
                    const rowContent = `
                        <div class="flex mb-1">
                            ...
                            <button type="button" class="ml-2 p-2 text-red-400 text-sm font-semibold rounded-md"
