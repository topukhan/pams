    ...
    <div class="container px-6 mx-auto grid">
        ...
        <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div class="p-4 bg-white rounded-lg shadow-xs  dark:bg-gray-800">
                <div class="p-3 mb-4 w-12 mx-auto text-orange-500 bg-orange-100 rounded-full dark:text-orange-100 dark:bg-orange-500">
             ...
             <!-- Card -->
             <div class="p-4 bg-white rounded-lg shadow-xs  dark:bg-gray-800">
                <div class="p-3 mb-4 w-12 mx-auto text-green-500 bg-green-100 rounded-full dark:text-green-100 dark:bg-green-500">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="p-4 bg-white rounded-lg shadow-xs  dark:bg-gray-800">
              ...
              <!-- Card -->
              <div class="p-4 bg-white rounded-lg shadow-xs  dark:bg-gray-800">
                <div class="p-3 mb-4 w-12 mx-auto text-teal-500 bg-teal-100 rounded-full dark:text-teal-100 dark:bg-teal-500">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
