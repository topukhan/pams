<x-frontend.student.layouts.master>
    <div class="container px-6 mx-auto grid">
        ...
        <div class=" grid gap-10 md:grid-cols-3 xl:grid-cols-3">

            <!-- Cards -->
            <div class="grid gap-6 mb-8 col-span-2 text-center md:grid-cols-3 xl:grid-cols-3">
                <!-- Card -->
                ...
                <div class="p-4 bg-white rounded-lg shadow-xs  dark:bg-gray-800">
                    <div
                        class="p-3 mb-4 w-12 mx-auto text-green-500 bg-green-100 rounded-full dark:text-green-100 dark:bg-green-500">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            ...
            {{-- Notice --}}
            <div class="mb-8 py-4 px-6 bg-white rounded shadow float-right dark:bg-gray-800">
